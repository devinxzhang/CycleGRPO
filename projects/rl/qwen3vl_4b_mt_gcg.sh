...
python3 -m verl.trainer.main \
    ...
    data.train_files="['./rl_dataset/gcg_exclude_grandf195k_195091_samples_train.parquet', './rl_dataset/gcg_exclude_grandf195k_195091_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet', './rl_dataset/gcg_grandf1k_1000_samples_train.parquet']" \
    data.val_files="['./rl_dataset/gcg_grandf1k_1000_samples_train.parquet']" \
    ...
    worker.rollout.n=8 \
    trainer.experiment_name=qwen3vl_4b_gcg_reproduce \
