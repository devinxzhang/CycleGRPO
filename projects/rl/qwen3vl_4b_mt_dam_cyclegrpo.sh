...
python3 -m verl.trainer.main \
    ...
    data.train_files="['./rl_dataset/dam_1k_samples_train_cyclegrpo.parquet','./rl_dataset/dam_1k_samples_train_captioning.parquet']" \
    data.val_files="['./rl_dataset/dam_1k_samples_train_cyclegrpo.parquet']" \
    ...
    trainer.experiment_name=qwen3vl_4b_mt_dam_cyclegrpo_caption \
