...
def main():
    ...
    # )
    # temp_save_root = "./temp_data_256x2_1005/ref_seg/refcoco"
    ...
    temp_save_root = "./temp_data_256x2_1005/ref_seg/refcocog"
    if not os.path.exists(temp_save_root):
        os.makedirs(temp_save_root)
    ...
    #     split_file='refs(unc).p',
    # )
    # temp_save_root = "./temp_data_256x2_1005/ref_seg/refclef"
    # if not os.path.exists(temp_save_root):
    #     os.makedirs(temp_save_root)
    ...
    pretrained_pth = "pretrained_weights/iter_70k_256x2_warmup.pth"
