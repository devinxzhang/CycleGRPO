...
class MultiRoundDataset(Dataset):
    def __init__(self):
        ...
        self.data = {
            ...
            'paco_lvis': COCO('./data/segllm_data/annotation_folder/paco_lvis_v1_train.json'),
...
def main(task_id):
    ...
    dataset_name = "segllm"
    temp_save_root = "./temp_data_256x2_0927/segllm/"
    ...
    train_file_root = "data/segllm_data/conversation_folder/all_data_mix_train"

    source_image_path = {
        'ade20k_train': "./data/ade/ADEChallengeData2016/images/training",
        'attributes_train': './data/coco/train2017',
        'cocostuff_train': './data/coco/train2017',
        'mr_lvis_train': './data/coco/train2017',
        'mr_paco_train': './data/coco/train2017',
        # 'mr_pascal_train': './data/Pascal_Part/JPEGImages/train',
        'mr_refcoco_hard_train': './data/coco/train2014',
        'mr_refcoco_train': './data/coco/train2014',
        'mr_refcoco+_hard_train': './data/coco/train2014',
        'mr_refcoco+_train': './data/coco/train2014',
        'mr_refcocog_hard_train': './data/coco/train2014',
        'mr_refcocog_train': './data/coco/train2014',
        'mr_vg_train': './data/VisualGenome'
    }
    ...
    for source_name in source_image_path.keys():
        ...
        for data_dict in tqdm.tqdm(data_dict_list[_start_:_end_]):
            ...
            ret_data_dict = {
                ...
                'raw_conversations': new_sources,
                'segmentation': mask_uuid_2_rle,
            }
