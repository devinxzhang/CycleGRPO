...
def main():
    ...
    image_file = "doc_chart_case3.png"
    bbox_x1y1x2y2_list = [[79, 182, 136, 240], [14, 20, 333, 58], [859, 315, 1056, 378], [368, 398, 717, 739]]
    bbox_x1y1x2y2_np = np.array(bbox_x1y1x2y2_list)
    ...
    gt_masks_image = visualize(image, sam_masks, ['']*len(sam_masks))
    gt_masks_image.save('doc_chart_case3_gt_masks.jpg')
    ...
    pred_masks_image = visualize(image, pred_masks, ['']*len(sam_masks))
    pred_masks_image.save('doc_chart_case3_recon_masks.jpg')
