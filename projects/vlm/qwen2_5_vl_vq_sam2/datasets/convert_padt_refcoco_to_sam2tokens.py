...
def main(task_id):
    ...
    temp_save_root = "./temp_data_256x2_0927/padt_refcoco/"
    ...
    train_json_files = [
        '<PATH_TO_DATA>/discrete_spatial_tokenizer/data/PaDT-MLLM/RefCOCO/refcoco_train.json',
        '<PATH_TO_DATA>/discrete_spatial_tokenizer/data/PaDT-MLLM/RefCOCO/refcoco+_train.json',
        '<PATH_TO_DATA>/discrete_spatial_tokenizer/data/PaDT-MLLM/RefCOCO/refcocog_train.json',
    ]
    ...
    for data_dict in tqdm.tqdm(all_data_dict[_start_:_end_]):
        ...
        image_path = os.path.join('./data/coco/train2014', image_name)
