...
if __name__ == "__main__":
    save_path = "./work_dirs/cycleGRPO_dam_ft/qwen3vl_4b_ckpt74k"
    cfg = Config.fromfile('projects/vlm/tokenmask/configs/cycleGRPO_dam_ft.py')
    ...
    pth_path = "./work_dirs/cycleGRPO_dam_ft/iter_73464.pth"
