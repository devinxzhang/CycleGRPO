...
work_dir = "work_dirs/qwen25vl_3b_cold_start_v2"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="cold_start_brief_gcg%200,cold_start_gres%100,cold_start_ver%100,cold_start_detail_gcg%100,cold_start_no_target_gres%100",
