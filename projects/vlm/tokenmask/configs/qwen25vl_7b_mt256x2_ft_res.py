...
work_dir = "work_dirs/qwen25vl_7b_ft_res_direction_order"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_padt_refcoco_direction_order%100,mask_generation_refseg_direction_order%100",
