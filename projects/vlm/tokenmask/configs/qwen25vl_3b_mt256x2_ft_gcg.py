...
work_dir = "work_dirs/qwen25vl_3b_ft_gcg"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_gcg%100,mask_generation_grandf%500,mask_generation_padt_ric%100,mask_generation_dw_gcg%100",
