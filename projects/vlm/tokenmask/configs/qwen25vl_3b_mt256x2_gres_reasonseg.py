...
work_dir = "work_dirs/qwen25vl_3b_gres_reasonseg"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_gres%100,mask_generation_reasonseg%200,mask_generation_lisa%500,mask_generation_refseg%100,mask_generation_padt_refcoco%100,mask_generation_padt_cocoseg%100",
