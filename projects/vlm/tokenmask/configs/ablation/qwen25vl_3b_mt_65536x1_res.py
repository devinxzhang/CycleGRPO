...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/Qwen2.5-VL-3B-MT-65536x1"
vqsam2_pretrained_pth = None
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/ablation_qwen25vl_3b_res_65536x1"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="ablation_65536x1_res%100,ablation_65536x1_res_direction_order%100",
