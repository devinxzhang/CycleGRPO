...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/Qwen2.5-VL-3B-MT-1024x4"
vqsam2_pretrained_pth = None
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/ablation_qwen25vl_3b_res_1024x4"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="ablation_1024x4_res%100,ablation_1024x4_res_direction_order%100",
