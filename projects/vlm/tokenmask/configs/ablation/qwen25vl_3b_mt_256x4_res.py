...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/Qwen2.5-VL-3B-MT-256x4"
...
work_dir = "work_dirs/ablation_qwen25vl_3b_res_256x4"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="ablation_256x4_res%100,ablation_256x4_res_direction_order%100",
