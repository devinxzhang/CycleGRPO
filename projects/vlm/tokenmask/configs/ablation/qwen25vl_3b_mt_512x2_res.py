...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/Qwen2.5-VL-3B-MT-512x2"
...
work_dir = "work_dirs/ablation_qwen25vl_3b_res_512x2"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="ablation_512x2_res%100,ablation_512x2_res_direction_order%100",
