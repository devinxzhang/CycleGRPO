...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "./work_dirs/qwen25vl_3b_segllm_1024x4/qwen25vl_3b_mt_ablation_1024x4"
vqsam2_pretrained_pth = "pretrained_weights/iter_17923.pth"
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/qwen25vl_3b_segllm_1024x4_v2"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="ablation_1024x4_segllm%100",
