...
work_dir = "work_dirs/qwen25vl_7b_ft_gres_only_v2"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_gres%100,mask_generation_lisa%1000,mask_generation_reasonseg%100,mask_generation_padt_cocoseg%100",
