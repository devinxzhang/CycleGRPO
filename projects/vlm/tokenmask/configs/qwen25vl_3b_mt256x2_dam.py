...
from projects.vlm.tokenmask.datasets import Qwen25VLDataset, Qwen25VLStreamingDataset, qwen25vl_vqsam2_collate_fn

#######################################################################
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/qwen25vl_3b_mt_instruct"
vqsam2_pretrained_pth = "pretrained_weights/iter_129437_256x2.pth"
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/qwen25vl_3b_dam_zoom_in"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_understanding_dam%50,mask_understanding_dam_zoom_in%100",
...
streaming_dataset = dict(
    type=Qwen25VLStreamingDataset,
    tokenizer=dict(
        type=AutoTokenizer.from_pretrained,
        pretrained_model_name_or_path=qwen25vl_path,
        cache_dir="./cache",
