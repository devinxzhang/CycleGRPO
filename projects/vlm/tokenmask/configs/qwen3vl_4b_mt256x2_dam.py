...
standard_dataset = dict(
    ...
    data_args=dict(
        model_type="qwen3vl",
        dataset_use="mask_understanding_dam%50,mask_understanding_dam_zoom_in%100,mask_understanding_gar_zoom_in%100",
