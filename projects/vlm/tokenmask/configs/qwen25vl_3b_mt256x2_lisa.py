...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "work_dirs/qwen25vl_3b_padt-refcoco-cocoseg-ric_refseg_gcg_grandf/qwen25vl_3b_sft"
vqsam2_pretrained_pth = "pretrained_weights/iter_129437_256x2.pth"
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/qwen25vl_3b_lisa_v2"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_lisa%2000",
