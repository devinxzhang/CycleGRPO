...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_psg_v1%100,mask_generation_psg_v2%100,mask_generation_psg_v3%100,mask_generation_psg_v4%100,mask_generation_padt_cocoseg%100",
