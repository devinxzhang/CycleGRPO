...
from projects.vlm.tokenmask.evaluation.utils import REFER, Summary, AverageMeter, intersectionAndUnionGPU, master_only
...
class RESDataset:
    ...
    def filter_data_dict(self, data_dict):
        names = ['image', 'text', 'gt_masks', 'img_id', 'image_file']
