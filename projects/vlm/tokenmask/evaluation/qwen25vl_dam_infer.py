...
def parse_args():
    ...
    parser.add_argument(
        '--vq_sam2_path',
        default="Qwen/Qwen2.5-VL-7B-SAMTok-co/mask_tokenizer_256x2.pth",
...
def main():
    ...
    with open('data/DLC-Bench/DLC-bench.json', 'r') as f:
    ...
    for eval_sample in eval_samples:
        ...
        for mask_sample in eval_sample['mask_samples']:
            ...
            image_path = os.path.join('data/DLC-Bench/images', image_name)
    ...
    with open('data/DLC-Bench/result_zoom_in_qwen25vl_3b.json', 'w') as f:
