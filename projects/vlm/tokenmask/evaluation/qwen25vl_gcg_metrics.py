...
def parse_args():
    ...
    parser.add_argument("--gt_dir_path", required=False, default="<PATH_TO_DATA>/Sa2VA-Training/glamm_data/annotations/gcg_val_test/",
...
def main():
    ...
    print("=================2. Evaluate Caption Quality\n")
