...
from projects.vlm.vq_sam2.models import QWEN25VL_TokenMask, DirectResize

from projects.vlm.vq_sam2.datasets_qwen25vl import TokenMaskDataset, qwen25vl_vqsam2_collate_fn

#######################################################################
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "Qwen/Qwen2.5-VL-3B-MT-256+128"
vqsam2_pretrained_pth = None
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/qwen25vl_3b_t2m_learning_codebook"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_refseg%400,mask_generation_invig%200",
