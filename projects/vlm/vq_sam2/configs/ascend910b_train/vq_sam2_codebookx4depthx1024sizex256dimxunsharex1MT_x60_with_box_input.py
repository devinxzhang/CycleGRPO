...
pretrained_pth = "./work_dirs/vq_sam2_codebookx4depthx1024sizex256dimxunsharex1MT_datasetxsa1bx10xcoconutx10xentityx10xpixelwebx10_continuesx40_with_box_input/iter_87737.pth"
...
train_dataset = dict(
    type=ConcatDataset, datasets=[
        sa1b_dataset, coconut_dataset, entity_dataset, pixelweb_dataset, sft_seg_dataset_part1
    ]
)
