...
#                          PART 1  Settings                           #
#######################################################################
qwen25vl_path = "./work_dirs/qwen25vl_3b_mask_loss_refseg_only_v9/hf_ckpt"
...
work_dir = "work_dirs/qwen25vl_3b_mask_loss_refseg_only_v11"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_refseg%100,mask_generation_cocopano%200",
