...
work_dir = "work_dirs/qwen25vl_3b_t2m_m2t_v3"
...
standard_dataset = dict(
    ...
    data_args=dict(
        ...
        dataset_use="mask_generation_coconut%100,mask_generation_v3det%100,mask_generation_refseg%100,mask_generation_invig%100,mask_generation_gcg%100,mask_generation_dw%100,mask_understanding_dam%100",
