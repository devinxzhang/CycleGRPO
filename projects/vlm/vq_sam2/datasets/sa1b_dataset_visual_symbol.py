...
class SA1BVisualSymbolDataset(Dataset):
    ...
    def __init__(
        ...
        self.visual_symbol = visual_symbol
    ...
    def prepare_data(self, index, fine=False):
        ...
        # 根据mask绘制各种视觉符号，包括边框，轮廓，箭头，任意的涂鸦等，总之是辅助人思考，关注图像中这个区域的那些符号
        # 然后每个视觉符号都保存为binary mask
